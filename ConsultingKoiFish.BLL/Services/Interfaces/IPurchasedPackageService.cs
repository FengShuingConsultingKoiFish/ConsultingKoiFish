...
namespace ConsultingKoiFish.BLL.Services.Interfaces
{
	public interface IPurchasedPackageService
	{
		...
		Task<BaseResponse> ExtendPurchasedPackage(PurchasedPackageViewDTO packageViewDTO, string userId);
		Task<PurchasedPackageViewDTO> GetUnavailablePackageForMember(int purchasedPackagedId, string userId);
